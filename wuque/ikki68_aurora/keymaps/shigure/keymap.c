...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_L1] = LAYOUT_68_ansi_split_rshift(
        ...
        _______,          KC_WBAK, KC_BSPC, KC_WFWD, CLIP_BD, _______, SEARCH,  TSK_MGR, _______, _______, _______, _______, _______,     _______,
    ...
    [_L3] = LAYOUT_68_ansi_split_rshift(
        UG_TOGG, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, _______, KC_F13,  KC_F14,      _______, _______,
